...
event OnInit(UIScreen Screen)
{
	...
	local int i,Rand1,Rand2,j;
	local array<TTile>	SavedTiles;
	local StateObjectReference NewUnit;
	ThisObj=self;
...
/*	NewGameState=class'XComGameStateContext_ChangeContainer'.static.CreateChangeState("New Popup Event");
	...
	{
		`XWORLD.GetUnoccupiedNonCoverTiles(InteractiveObjectState.TileLocation,50,SavedTiles);
		break;
	}
	for(i=0;i<rand1;i++)
	{
